...
export default function NewSavingsAccountModal({ onClose, onCreate }: Props) {
    ...
    >
      ...
      >
        <div className="mb-4 flex items-start justify-between">
          <h2 className="text-lg font-bold">Nova caixinha ou investimento</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              className="input"
              placeholder="Ex: Reserva de emergência, Viagem, Tesouro Selic…"
              value={name}
